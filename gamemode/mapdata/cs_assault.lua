	...
	Entities = {
		...
		
		{
			...
			Functions = {
				...
				SetPos = { Vector( 6519, 7178, -856 ) },
				SetAngles = { Angle( 0, -77, 0 ) },
		...
		
		{
			...
			Functions = {
				...
				SetPos = { Vector( 6387, 4910, -600 ) },
				SetAngles = { Angle( 0, -121, 0 ) },
